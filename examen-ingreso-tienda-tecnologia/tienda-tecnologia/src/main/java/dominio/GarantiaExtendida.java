...
public class GarantiaExtendida {
    ...
    public GarantiaExtendida(Producto producto, String nombreCliente) { //constructor
        this.fechaSolicitudGarantia = new Date();
        this.producto = producto;
        this.nombreCliente= nombreCliente;
    }

    public GarantiaExtendida(Producto producto, Date fechaSolicitudGarantia, Date fechaFinGarantia, //constructor
