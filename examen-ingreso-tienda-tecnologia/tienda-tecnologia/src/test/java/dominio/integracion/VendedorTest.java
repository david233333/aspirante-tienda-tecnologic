...
public class VendedorTest {
	...
	private static final String CODIGO_VOCALES = "3EWAZI";
	private static final String NOMBRE_CLIENTE = "David Ceballos";
	...
	@Test
	public void elProductoTieneTresVocales() {

		// arrange
		Producto producto = new ProductoTestDataBuilder().conCodigo(CODIGO_VOCALES).build();
